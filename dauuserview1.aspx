<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dauuserview1.aspx.cs" Inherits="Auction.dauuserview1" %>
       ...
       <div Style="background:#3E828F">
        <table width="100%">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="qty" HeaderText="Item No" />
                ...
                <asp:TemplateField>
            <ItemTemplate>
                <asp:LinkButton ID="lnkDetails" runat="server" Text="Bid" HeaderText="BID" PostBackUrl='<%# "~/dauuserbuy1.aspx?ID=" + Eval("itemid") %>'></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
            </Columns>
