<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="seausermain1.aspx.cs" Inherits="Auction.seausermain1" %>
        ...
        <table width="100%" bgcolor="#D7DDD1">
         ...
         <div Style="background:#3E828F">
            ...
            >Back</asp:HyperLink>
                 ...
                 <tr>
                     <td>
                           <asp:Image ID="Image1" runat="server" ImageUrl="~/images/seall.jpg"  />                     </td>
                      <td>
                 ...
                 <tr>
                     <td>
                       <asp:HyperLink ID="HyperLink1" runat="server" style="text-decoration:none" Font-Bold="True" NavigateUrl="~/seauserview1.aspx"
            >View Items</asp:HyperLink>
                 ...
                 <tr>
                     <td>
                           <asp:HyperLink ID="HyperLink3" runat="server" style="text-decoration:none" Font-Bold="True" NavigateUrl="~/seausersell1.aspx"
            >Item Registration</asp:HyperLink>
                     </td>
                      <td>
                 ...
                 <tr>
                     <td>
                         <!-- <asp:HyperLink ID="HyperLink2" runat="server" style="text-decoration:none" Font-Bold="True" NavigateUrl="~/seauserbuy1.aspx"
            >Buy</asp:HyperLink> -->
                     </td>
                      <td>
