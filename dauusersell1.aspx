<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dauusersell1.aspx.cs" Inherits="Auction.dauusersell1" %>
    ...
    <form id="form1" runat="server">
        ...
        <table width="100%">
            <tr>
                ...
                <td width="20%">
                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" NavigateUrl="~/dauusermain1.aspx"
            >Back</asp:HyperLink>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2">
                    <img src="images/zedge3581nl.jpg"  />
                </td>
                  <td>
            ...
            ErrorMessage="Must Enter Digits Only"  ValidationExpression="[/0-9]{1,15}">*</asp:RegularExpressionValidator>
             ...
             <tr>
                ...
                <td style="width: 100px">
                     <asp:TextBox ID="TextBox6" runat="server" TabIndex="5"></asp:TextBox></td>
                  <td>
