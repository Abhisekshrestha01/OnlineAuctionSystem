<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminstr1.aspx.cs" Inherits="Auction.adminstr1" %>
    ...
    <form id="form1" runat="server">
        ...
        <div Style="background:#3E828F">
            <table width="100%" style="text-align:center">
                <tr>
                    <td>
                         <asp:Image ID="Image2" runat="server" Height="48px" ImageUrl="~/images/zedge1039nl.jpg"
             Width="234px" />
                    </td>
                    <td>
            ...
            OnPageIndexChanging="GridView1_PageIndexChanging"  Width="535px">
            ...
            <Columns>
                ...
                <asp:TemplateField>
            <ItemTemplate >
                <asp:LinkButton ID="lnkDetails" runat="server" Text="Result" HeaderText="Results" PostBackUrl='<%# "~/adminstrresults1.aspx?ID=" + Eval("itemid") %>'></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
