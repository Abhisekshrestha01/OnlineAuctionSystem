<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminsea1.aspx.cs" Inherits="Auction.adminsea1" %>
    ...
    <form id="form1" runat="server">
        ...
        <div Style="background:#3E828F">
            <table width="100%" style="text-align:center">
                ...
                CellPadding="3" CellSpacing="2"  Width="535px" OnPageIndexChanging="GridView1_PageIndexChanging">
                ...
                <asp:TemplateField>
            <ItemTemplate >
                <asp:LinkButton ID="lnkDetails" runat="server" Text="Result" HeaderText="Results" PostBackUrl='<%# "~/adminsearesult11.aspx?ID=" + Eval("itemid") %>'></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
