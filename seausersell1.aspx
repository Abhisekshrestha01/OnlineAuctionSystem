<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="seausersell1.aspx.cs" Inherits="Auction.seausersell1" %>
    ...
    <form id="form1" runat="server">
        ...
        <table width="100%">
            <tr>
                ...
                <td width="20%">
                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" NavigateUrl="~/seausermain1.aspx"
            >Back</asp:HyperLink>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2">
                    <img src="images/zedge1763nl.jpg" />
                </td>
                  <td>
            ...
            <tr>
                ...
                <td style="width: 100px">
                  ...
                  <td>
                      <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="TextBox4"
            ErrorMessage="Must Enter Digits Only"  ValidationExpression="[/0-9]{1,15}">*</asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                     <asp:Button ID="Button3" runat="server" OnClick="Button1_Click"  Text="Submit" />&nbsp:&nbsp:&nbsp:&nbsp:
        <asp:Button ID="Button4" runat="server" OnClick="Button2_Click"  Text="Reset" />
                </td>
            </tr>
                    </table>
                </td>
