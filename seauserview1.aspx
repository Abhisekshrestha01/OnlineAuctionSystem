<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="seauserview1.aspx.cs" Inherits="Auction.seauserview1" %>
        ...
        <table width="100%">
            ...
            <tr>
             ...
             <tr>
                ...
                Width="535px" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging">
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
            <ItemTemplate>
                <asp:LinkButton ID="lnkDetails" runat="server" Text="Bid" HeaderText="BID" PostBackUrl='<%# "~/seauserbuy1.aspx?ID=" + Eval("itemid") %>'></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
                </Columns>
